...
If upgrading, you may already have a user named "riak", but no home folder. If this is the case, you will need to to create /home/riak and run `chown riak:riak /home/riak` before running `riak start`.
